        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectPostion != -1) {
                    ...
                    TextView textView = (TextView) getChildAt(selectPostion).findViewById(R.id.text);
                    if (data.get(selectPostion).mothFlag != 0) {
                        textView.setTextColor(0xff9299a1);
                    } else {
                        textView.setTextColor(0xff444444);
                    }
                    getChildAt(potsion).setSelected(true);
                    TextView textView1 = (TextView) getChildAt(potsion).findViewById(R.id.text);
