...
public class AddressPickTaskAll extends AsyncTask<String, Void, ArrayList<Province>> {
    ...
    public AddressPickTaskAll(Activity activity) {
    ...
    protected ArrayList<Province> doInBackground(String... params) {
        ...
        try {
            String json = ConvertUtils.toString(activity.getAssets().open("cityall.json"));
