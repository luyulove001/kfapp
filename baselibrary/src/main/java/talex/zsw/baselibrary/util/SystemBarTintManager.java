...
public class SystemBarTintManager
{
	...
	static
	{
		...
		try
		{
			...
			sIsMiuiV6 =
				"V6".equals((String) methodGetter.invoke(sysClass, "ro.miui.ui.version.name"));
		} catch (Exception e)
		{
			e.printStackTrace();
		} finally
	...
	public void setStatusBarDarkMode(boolean darkmode, Activity activity)
	{
		if (sIsMiuiV6)
		{
			...
			try
			{
				...
				extraFlagField
					.invoke(activity.getWindow(), darkmode ? darkModeFlag : 0, darkModeFlag);
			} catch (Exception e)
			{
				e.printStackTrace();
			}
